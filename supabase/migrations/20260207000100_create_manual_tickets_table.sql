-- Create manual_tickets table for sales via WhatsApp/in-person
...
CREATE INDEX IF NOT EXISTS idx_manual_tickets_event_id ON public.manual_tickets(event_id);
CREATE INDEX IF NOT EXISTS idx_manual_tickets_buyer_cpf ON public.manual_tickets(buyer_cpf);
CREATE INDEX IF NOT EXISTS idx_manual_tickets_created_by ON public.manual_tickets(created_by);
CREATE INDEX IF NOT EXISTS idx_manual_tickets_status ON public.manual_tickets(status);
